                ...
                GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          if(reportsList[index]['title'] == 'VACCINE COMPATIBILITY') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                          ...
                          } else if(reportsList[index]['title'] == 'MEDICAL ASSISTANCE') {
                            // Navigator.push(
                            //   context,
                            //   MaterialPageRoute(
                        ...
                        child: Card(
                          ...
                          child: Center(
                              child: Column(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(bottom: 200.0, left: 10.0, top: 10.0),
                                    child: Center(
                                      child: Text(
